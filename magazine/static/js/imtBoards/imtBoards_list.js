...
function search() {
    ...
    if (searchCategory !== '' || searchWord !== '') {
        location.href = `/imtBoards_list/?searchCategory=${searchCategory}&searchWord=${searchWord}`
    }
}
...
function prev(p) {
    ...
    if (searchCategory !== '' || searchWord !== '') {
        location.href = `/imtBoards_list/?searchCategory=${searchCategory}&searchWord=${searchWord}&p=${p}`
    } else {
        location.href = `/imtBoards_list/?p=${p}`
    }
}
